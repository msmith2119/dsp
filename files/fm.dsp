//Sin(ampl=1.0,f=0.5,T=2) n0
RandomSquare(ampl=1.0,tmin=1,tmax=2,T=30) n0
Fm(ampl=1.0,f=1000,src=n0,pdev=1,T=30) nfm
...
Subtract(gain=10) o1 o2 out
Sinc(fc=100,N=80) out out1
.plot  out1   10
